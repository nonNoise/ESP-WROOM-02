...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("ESP-WROOM-02-Note 1.0 documentation");
        $("div.related:last  ul li:not(.right):first a").text("ESP-WROOM-02-Note 1.0 documentation");
    }
});